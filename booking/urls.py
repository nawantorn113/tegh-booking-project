...
urlpatterns = [
    # --- Auth & Dashboard ---
    path('', views.dashboard_view, name='root'), # เข้าเว็บมาเจอ Dashboard เลย
    ...
    path('booking/<int:booking_id>/read/', views.mark_notification_read, name='mark_notification_read'),
    ...
    # --- APIs (สำหรับ FullCalendar & Charts) ---
