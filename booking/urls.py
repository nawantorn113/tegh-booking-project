...
urlpatterns = [
    ...
    path('booking/<int:booking_id>/delete/', views.delete_booking_view, name='delete_booking'), # (สำหรับหน้า History)
    ...
    path('api/booking/delete/<int:booking_id>/', views.delete_booking_api, name='delete_booking_api'), # (สำหรับปฏิทิน)
