...
urlpatterns = [
    ...
    # Dashboard & Main
    path('', views.master_calendar_view, name='master_calendar'), # Default to calendar or dashboard
    ...
    # APIs
    path('api/user-autocomplete/', views.UserAutocomplete.as_view(), name='user-autocomplete'),
